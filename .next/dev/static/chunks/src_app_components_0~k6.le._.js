...
function Calendar({ serverId }) {
    _s();
    const now = new Date();
    const [year, setYear] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(now.getUTCFullYear());
    const [month, setMonth] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(now.getUTCMonth() + 1);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Calendar.useEffect": ()=>{
            setLoading(true);
            fetch(`/api/submissions?month=${monthKey}&serverId=${serverId}`).then({
                "Calendar.useEffect": (r)=>r.json()
            }["Calendar.useEffect"]).then({
                "Calendar.useEffect": (data)=>setSubmissions(data.submissions ?? [])
            }["Calendar.useEffect"]).finally({
                "Calendar.useEffect": ()=>setLoading(false)
            }["Calendar.useEffect"]);
        }
    }["Calendar.useEffect"], [
        monthKey,
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                edit.submissionId && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    onClick: deleteEdit,
                                    disabled: saving,
                                    style: {
                                        color: 'red'
...
_s(Calendar, "HpfaI7WNddE7iDNT3CZgneVId+M=");
_c = Calendar;
var _c;
...
function Stats({ serverId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Stats.useEffect": ()=>{
            fetch(`/api/stats?serverId=${serverId}`).then({
                "Stats.useEffect": (r)=>r.json()
            }["Stats.useEffect"]).then(setData).finally({
                "Stats.useEffect": ()=>setLoading(false)
            }["Stats.useEffect"]);
        }
    }["Stats.useEffect"], [
        serverId
...
_s(Stats, "Zn4cs3026OJRBhxLd0Oqj+bUOXY=");
_c = Stats;
...
//# sourceMappingURL=src_app_components_0~k6.le._.js.map